...
function onCreate()
         makeLuaSprite('win', 'achievements/ARach', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'dodged', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'beat accelerant cover', 200, 120, 40) -- change your description text
