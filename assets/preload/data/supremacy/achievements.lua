...
function onCreate()
         makeLuaSprite('win', 'achievements/ATach', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'he going pissed...', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'beat supremacy cover', 200, 120, 40) -- change your description text
