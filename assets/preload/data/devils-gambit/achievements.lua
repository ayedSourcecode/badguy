...
function onCreate()
         makeLuaSprite('win', 'achievements/NMach', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'real nightmare', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'beat devils gambit cover', 200, 120, 40) -- change your description text
